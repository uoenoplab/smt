...
/**
 * Extra Notes
 * hash set here will be used at get_rps_cpu
 * sock_flow_table->mask is rps_sock_flow_entries
 * rps_cpu_mask num_cpus -> power of 2 e.g. 6 cores -> 0111 (8)
 *
 ...
 *
 * hash = 0111 + 1 -> 1000 + cpu
 * hash & sock_flow_table->mask = hash
 * ident ^ hash -> 0
 * next_cpu = 1000 + cpu & rps_cpu_mask -> cpu
 */
